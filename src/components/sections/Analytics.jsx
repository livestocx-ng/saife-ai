...
const Analytics = () => {
    ...
    return (
        <section className="section-padding bg-cream font-display" id="analytics">
            <div className="container-custom">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                    {keyMetrics.map((metric, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className="bg-cream-card rounded-xl p-6 shadow-medium hover:shadow-strong transition-shadow"
                            >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                    ...
                    {/* Engagement Metrics */}
                    <div className="bg-cream-card rounded-xl p-6 shadow-medium">
                ...
                {/* Key Insights */}
                <div className="bg-cream-card rounded-xl p-8 shadow-medium">
